...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader$DBObserver;
    }
.end annotation
...
# static fields
.field private static final ACTION_CHECK_UPLOADED_SHOOTING_MODES_LIST:Ljava/lang/String; = "com.samsung.android.provider.shootingmodeprovider.action.CHECK_UPLOADED_SHOOTING_MODES_LIST"

.field private static final ACTION_SYNC_UPLOADED_SHOOTING_MODES_LIST_DB:Ljava/lang/String; = "com.samsung.android.provider.shootingmodeprovider.action.SYNC_UPLOADED_SHOOTING_MODES_LIST_DB"

.field private static final ACTION_UPDATE_SHOOTING_MODES_DB:Ljava/lang/String; = "com.samsung.android.provider.shootingmodeprovider.action.UPDATE_SHOOTING_MODES_DB"
...
.field private static final PACKAGE_SHOOTING_MODES_PROVIDER:Ljava/lang/String; = "com.samsung.android.provider.shootingmodeprovider"

.field private static final PATH_NEW_SHOOTING_MODES_UPLOAD_INFO:Ljava/lang/String; = "new_modes_upload_info"
...
.field private static final URI_SHOOTING_MODES:Landroid/net/Uri;
...
.method static constructor <clinit>()V
    ...
    .line 49
    const-string v0, "content://com.samsung.android.provider.shootingmodeprovider"

    invoke-static {v0}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    sput-object v0, Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader;->URI_AUTHORITY:Landroid/net/Uri;
    ...
    sput-object v0, Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader;->URI_SHOOTING_MODES:Landroid/net/Uri;
    ...
    const-string v1, "com.sec.android.app.camera.shootingmode.sight.SightActivity"
...
.method public constructor <init>(Lcom/sec/android/app/camera/interfaces/CameraContext;)V
    ...
    .line 184
    new-instance v0, Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader$DBObserver;
    ...
    invoke-direct {v0, p0, v1}, Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader$DBObserver;-><init>(Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader;->mDBObserver:Landroid/database/ContentObserver;
...
.method static synthetic access$100(Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader;)Lcom/sec/android/app/camera/interfaces/CameraContext;
    .locals 1
    .param p0, "x0"    # Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader;

    .prologue
    .line 44
    iget-object v0, p0, Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader;->mCameraContext:Lcom/sec/android/app/camera/interfaces/CameraContext;

    return-object v0
.end method

.method private checkUploadedShootingModeList()V
    .locals 3
    ...
    const-string v2, "checkUploadedShootingModeList"
    ...
    const-string v1, "com.samsung.android.provider.shootingmodeprovider.action.CHECK_UPLOADED_SHOOTING_MODES_LIST"
...
.method public static syncUploadedShootingModeListDBWithServer(Landroid/content/Context;)V
    .locals 3
    ...
    const-string v2, "syncUploadedShootingModeListDBWithServer"
    ...
    invoke-static {v1}, Lcom/sec/android/app/camera/plugin/PlugInShootingModesStorage;->setNewShootingModesUploadInfo(Z)V
    ...
    .line 238
    const-string v1, "com.samsung.android.provider.shootingmodeprovider.action.SYNC_UPLOADED_SHOOTING_MODES_LIST_DB"
...
.method public declared-synchronized loadShootingModes()V
    ...
    sget-object v4, Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader;->URI_SHOOTING_MODES:Landroid/net/Uri;
    ...
    const-string v8, "DB is empty. start service."
    ...
    .line 266
    :cond_5
    invoke-direct/range {p0 .. p0}, Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader;->checkUploadedShootingModeList()V
...
.method public registerObserver()V
    ...
    sget-object v1, Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader;->URI_AUTHORITY:Landroid/net/Uri;

    const/4 v2, 0x1

    iget-object v3, p0, Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader;->mDBObserver:Landroid/database/ContentObserver;
...
.method public unregisterObserver()V
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/plugin/PlugInShootingModesLoader;->mDBObserver:Landroid/database/ContentObserver;
