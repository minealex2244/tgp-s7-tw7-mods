...
.method private addToken(Ljava/lang/StringBuilder;Ljava/util/ArrayList;I)V
    ...
    .prologue
    .line 664
    .local p2, "tokens":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;>;"
...
.method private static doSelfValidation()Z
    ...
    .end local v0    # "c":C
    .end local v1    # "cmp":I
    .end local v2    # "curString":Ljava/lang/String;
    :goto_2
    return v5
    ...
    .restart local v2    # "curString":Ljava/lang/String;
    :cond_1
    move-object v4, v2
...
.method public static getInstance()Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin;
    ...
    .line 362
    .local v0, "aLocale":Ljava/util/Locale;
    ...
    .line 374
    .end local v0    # "aLocale":Ljava/util/Locale;
    :catchall_0
    move-exception v2
    ...
    .line 361
    .restart local v0    # "aLocale":Ljava/util/Locale;
    :cond_1
...
.method private pinyinSuffixType(C)I
    ...
    .line 707
    .restart local v7    # "sample":Ljava/lang/String;
    invoke-virtual {v0, v7}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z
...
.method public get(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 601
    .local v6, "tokens":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;>;"
    ...
    .line 641
    .local v4, "t":Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;
    ...
    .end local v4    # "t":Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;
    :cond_b
    invoke-virtual {v3}, Ljava/lang/StringBuilder;->length()I
...
.method public getPinyin(C)Ljava/lang/String;
    ...
    .line 403
    .local v8, "token":Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;
    invoke-static {p1}, Ljava/lang/Character;->toString(C)Ljava/lang/String;
...
.method public getPinyinString(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 775
    .local v3, "tokens":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;>;"
    const-string v1, ""

    .line 776
    .local v1, "pinyinTitle":Ljava/lang/String;
    const/4 v0, 0x0
    ...
    .line 778
    .local v2, "token":Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;
    ...
    .line 780
    .end local v2    # "token":Lcom/android/launcher3/util/locale/hanzi/HanziToPinyin$Token;
    :cond_1
    const-string v4, "AoS ******"
